...
const suggestions = [
  {
    ...
    description:
      "Optimalizácia využitia priestoru prehodnotením súčasného rozloženia",
    progress: 65,
  },
  {
    title: "Energetická efektívnosť",
    description:
      "Zvážte automatické ovládanie osvetlenia a inteligentné systémy HVAC",
    progress: 82,
  },
  {
    title: "Plán údržby",
    description:
      "Naplánujte pravidelné kontroly HVAC systému a preventívnu údržbu",
    progress: 45,
  },
  {
                ...
                >
                  ...
                  <div className="w-full mt-2">
                    ...
                    <Progress
                      ...
                      className={cn(
                        "h-2",
                        suggestion.progress >= 80
                          ? "bg-green-100 [&>div]:bg-green-500"
                          : suggestion.progress >= 60
                          ? "bg-blue-100 [&>div]:bg-blue-500"
                          : suggestion.progress >= 40
                    ...
                    <div className="relative w-24 aspect-square">
                      ...
                      <div
                        ...
                        style={{
                          ...
                          WebkitMask:
                            "radial-gradient(transparent 55%, white 55%)",
                        }}
                      />
                      <div
                        ...
                        style={{
                          background:
                            "repeating-conic-gradient(from 0deg, transparent 0deg 15deg, rgba(0, 0, 0, 0.05) 15deg 30deg)",
                          mask: "radial-gradient(transparent 55%, white 55%)",
                          WebkitMask:
                            "radial-gradient(transparent 55%, white 55%)",
                        }}
                  ...
                  {messages.map((message, index) => (
                    <div
                      ...
                      className={cn(
                        ...
                        message.severity === "blue" &&
                          "bg-blue-50 dark:bg-blue-950/50",
                        message.severity === "yellow" &&
                    ...
                    >
                      ...
                      <Badge
                        ...
                        className={cn(
                          "shrink-0",
                          message.severity === "blue" &&
                            "border-blue-200 bg-blue-100 text-blue-900 dark:border-blue-800 dark:bg-blue-900/50 dark:text-blue-200",
                          message.severity === "yellow" &&
                            "border-yellow-200 bg-yellow-100 text-yellow-900 dark:border-yellow-800 dark:bg-yellow-900/50 dark:text-yellow-200",
                          message.severity === "red" &&
                            "border-red-200 bg-red-100 text-red-900 dark:border-red-800 dark:bg-red-900/50 dark:text-red-200"
                        )}
                      >
